...
import sampleFile from "../../assets/Sample_data_students.xlsx";
...
const ManageStudents = () => {
    ...
    // --- Validation Function ---
      ...
      const validateFieldValue = (key, row) => {
        ...
        if (key === "gitamEmail") {
          ...
          if (!value.match(/@(gitam\.edu|gitam\.in|GITAM\.EDU|GITAM\.IN)$/)) {
            return "Student GITAM Email Id must end with @gitam.edu or @gitam.in.";
          }
        }
        if (key === "name") {
  ...
  const inputStyle = {
      ...
      if (!parsedRows.length) {
        ...
        const updatedRows = parsedRows.map((row) => {
            ...
            let newRow = { ...row,
                ...
                yearOfPassout: row["Year of Passout"],
    ...
    return(
        <DashboardLayout>
            ...
            <div className='admin-form-whole'>
                <div className='admin-form'>
                    <h3>Add Students(.xlsx or .csv)
                        <br/>
                        {/* Sample File Download Link */}
                        <a
                            href={sampleFile}
                            download="sample_students.xlsx"
                    ...
                    {studentRows.length > 0 && (
                        <div className="default-password" style={{ marginTop: "10px" }}>
                            <label className='labels'>
                                Default Password for Students:</label>
                            <input
                                type="text"
            ...
            {studentRows.length > 0 && (
            <div style={tableContainerStyle}>
            <h3 style={{color:"var(--primary-color)"}}>Students Preview & Edit</h3>
            <table className="table" style={tableStyle}>
            <thead>
              <tr>
                {Object.keys(studentRows[0]).map((key) => (
        ...
        <div className="popup-success">
            <img src={successImg} alt="Success" />
            <span>Students added successfully!</span>
            </div>
        )}
